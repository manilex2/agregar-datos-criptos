...
app.get('/', async function (solicitud, respuesta) {
    ...
    function agregarDatos(recogerDatos) {
        for(i = 0; i < recogerDatos.length; i++){
            ...
            arreglo.push([cripto, indice, fecha, preop, propost, p1, p2, p3, p4, pm, pm2, sl, sl2]);
        };
        let sql = "INSERT INTO datos (cripto, indice, fecha, preop, propost, p1, p2, p3, p4, pm, pm2, sl, sl2) VALUES ?";
